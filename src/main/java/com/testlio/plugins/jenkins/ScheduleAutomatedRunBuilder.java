...
public class ScheduleAutomatedRunBuilder extends Builder implements SimpleBuildStep {
  ...
  public void perform(Run<?, ?> run, FilePath workspace, EnvVars env, Launcher launcher, TaskListener listener)
    ...
    run.addAction(config);
      ...
      headers.set("Authorization", "Basic eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..hpgurpx1O6It7NbanGH0k2mFLj7ZIsYr4-0cWW5prE8");
